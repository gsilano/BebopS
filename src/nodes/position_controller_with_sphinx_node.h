...
#ifndef BEBOP_CONTROL_POSITION_CONTROLLER_WITH_BEBOP_NODE_H
#define BEBOP_CONTROL_POSITION_CONTROLLER_WITH_BEBOP_NODE_H
...
namespace bebopS {
    ...
    class PositionControllerWithSphinxNode{
        public:
            PositionControllerWithSphinxNode();
            ~PositionControllerWithSphinxNode();
...
#endif // BEBOP_CONTROL_POSITION_CONTROLLER_WITH_BEBOP_NODE_H
